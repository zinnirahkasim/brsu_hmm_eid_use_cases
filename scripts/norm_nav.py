...
def main():
    ...
    sss.move("arm", "home")
    sss.move("base", "T1")
    rospy.loginfo('Arm at home base at T1')
    sss.move("arm", "candle")
    sss.move("base", "T2")
    rospy.loginfo('Arm at candle base at T2')
    sss.move("arm", "out_of_view")
    sss.move("base", "T3")
    rospy.loginfo('Arm at outofview base at T3')
    sss.move("arm", "platform_centre")
    sss.move("base", "T4")
    rospy.loginfo('Arm at platform_centre base at T4')
    sss.move("arm", "grasp_laying_mex")
    sss.move("base", "T5")
    rospy.loginfo('Arm at candle base at T5')
    sss.move("arm", "tower_right")
    sss.move("base", "T6")
    rospy.loginfo('Arm at tower_right base at T6')
